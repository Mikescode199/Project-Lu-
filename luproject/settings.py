"""
Django settings for luproject project.
...
SECRET_KEY = 'qie-)*x39+z@4=w(s85qyzykhg#j*tdjk6ihkbh@u)*rmsk&65'
...
WSGI_APPLICATION = 'luproject.wsgi.application'
